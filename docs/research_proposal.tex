...
\end{equation}
Across the four shape groups, this yields approximately 400--800M parameters in the output heads. Combined with the encoder and embeddings, the full hypernetwork totals $\sim$130M trainable parameters.
